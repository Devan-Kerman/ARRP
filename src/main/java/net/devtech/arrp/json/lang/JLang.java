...
public class JLang implements Cloneable {
    ...
    public JLang allPotion(Identifier id,
        ...
        return this.drinkablePotion(id, drinkablePotionName)
                .splashPotion(id, splashPotionName)
                .lingeringPotion(id, lingeringPotionName)
                .tippedArrow(id, tippedArrowName);
    }
